        ...
        <form name="orderInfo" method="post" action="order2.jsp">
          <div class="recycleCap">
            <label for="recycle_rq">
              ...
              <p><span>커피 한 잔으로 실천하는 기후동행!</span><br>사용하신 캡슐을 재활용 백 안에 넣어주세요. 다음 배송일자에 맞추어 기사님이 재활용 백을 수거해드립니다.</p>
              <input type="checkbox" name="recycle" value="recycle" id="recycleCheckbox">
            </label>
          </div>

          <div class="cart_section2">
            <div class="cart_title">
              주문자 정보(내 정보 그대로 불러오기. 수정 불가.)
            </div>
			<%
...
%>
          ...
          <div class="cart_section3">
            ...
            <div class="cartWrap">
              ...
              <th>주소<br><input type="text" name="zipNo" id="zipNo" placeholder="우편번호를 입력해주세요">
            ...
            <div class="cartWrap">
              ...
              <tr>
                <th>
                  <p>
                    <label>
                      <input type="radio" name="payment" value="신용카드" id="card">
                      신용카드</label>
                    <br>
                    <label>
                      <input type="radio" name="payment" value="카카오페이" id="kakao">
                      카카오페이</label>
                    <br>
                    <label>
                      <input type="radio" name="payment" value="무통장입금" id="bank">
                      무통장입금</label>
                    <br>
                  </p>
                </th>
          ...
          <div class="cart_Info_button">
           ...
           <input type="button" class="btn_nextPage" value="다음 단계로  >" onclick="submitForm()">
          </div>
        </form>
      </div>

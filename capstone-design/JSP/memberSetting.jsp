...
<body>
    ...
    <div id="wrap">
		...
		<% 
		 ...
		 String visiblePW = pw.substring(0, 3);      // 앞의 세 글자만 보이게 함

         for(int i = 0; i < pw.length() - 2; i++) {
         visiblePW += "*";      // 나머지 글자를 *로 대체
    }
        ...
        <div class="memberSetting_wrap">
            <div class="info_cont">
                ...
                <div class="member_info">
                    <h3>기본 배송지</h3>
                    <div class="member_list">
                        <span class="gray-40">우편번호</span>
                        <span class="gray-80"><%= zip%></span>
                        <span class="gray-40">상세 주소</span>
                        <span class="gray-80"><%= addr%><%= addr2%></span>
                    </div>
                </div>
               <a href="memberUpdate.jsp"> <div class="memberUpdate_btn">회원 정보 수정</div></a>
            </div>
        </div>
        <footer>
            <div class="footer1">
